    ...
    <div className="-mx-8 -mt-4">
      ...
      <section className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden bg-white px-8 text-center">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-violet-200/50 blur-3xl" />
          <div className="absolute -top-16 right-0 h-80 w-80 rounded-full bg-sky-200/50 blur-3xl" />
          <div className="absolute bottom-0 left-1/2 h-64 w-96 -translate-x-1/2 rounded-full bg-rose-100/60 blur-3xl" />
        </div>
        <div className="z-10 flex flex-col items-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-slate-400">
            New arrivals every week
          </p>
          <h1 className="mb-6 max-w-3xl text-5xl font-bold leading-tight tracking-tight text-slate-900">
